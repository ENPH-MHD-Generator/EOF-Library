...
def main(out_msh: str):
    ...
    gmsh.model.addPhysicalGroup(2, y0, tag=40)
    gmsh.model.setPhysicalName(2, 40, "CathodeSurface")

    gmsh.model.addPhysicalGroup(2, yH, tag=41)
    gmsh.model.setPhysicalName(2, 41, "AnodeSurface")

    gmsh.model.addPhysicalGroup(2, z0 + zW, tag=30)
    gmsh.model.setPhysicalName(2, 30, "InsulatorSurface")

    gmsh.model.addPhysicalGroup(3, [vol], tag=1)
    gmsh.model.setPhysicalName(3, 1, "Plasma")
